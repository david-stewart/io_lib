...
void io_fmt (TProfile* hg, ioOptMap _override, ioOptMap dict) {
    dict += _override;
...
void io_fmt (TH1D* hg, TPad* pad, ioOptMap _override, ioOptMap dict) {
...
void io_fmt (TH1D* hg, ioOptMap _override, ioOptMap dict) {
    /* cout << " alpha " << endl; */
    dict += _override;
