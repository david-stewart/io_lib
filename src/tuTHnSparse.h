...
class tuTrackSparse {
    ...
    tuTrackSparse(const char* bin_file, const char* tag="", 
            bool debug_print=false);
    tuTrackSparse(THnSparseD* _data_jet, THnSparseD* data_trig, 
            bool debug_print=false);
    void write();
...
class tuTrackSparse {
    ...
    tuBinVec* bins {nullptr};
    tuTrackSparse(const char* bin_file, const char* tag="");
    tuTrackSparse(THnSparseD* _data_track, THnSparseD* data_trig);
    void write();
...
class tuAjSparse_dPhi {
    ...
    bool scaleByBinWidth=true;
    tuBinVec* bins {nullptr};
    tuAjSparse_dPhi(const char* bin_file, const char* tag="", double _recoil_match=tu_halfpi);
